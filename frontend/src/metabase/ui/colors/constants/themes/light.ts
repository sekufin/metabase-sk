...
export const METABASE_LIGHT_THEME: MetabaseThemeV2 = {
  ...
  colors: {
    ...
    "illustration-brand-secondary": baseColors.sekufinOrange[10],
    "illustration-brand-tertiary": baseColors.sekufinOrange[5],
    "metabase-brand": baseColors.sekufinOrange[40],
    "metabase-brand-hover": baseColors.sekufinOrange[30],
