...
export const METABASE_DARK_THEME: MetabaseThemeV2 = {
  ...
  colors: {
    ...
    // Sekufin fork: marca naranja (#ff6c2f) reemplaza el azul default.
    brand: baseColors.sekufinOrange[40],
    "brand-hover": baseColors.sekufinOrange[30],
    danger: baseColors.lobster[50],
    error: baseColors.lobster[50],
    filter: baseColors.octopus[40],
    focus: baseColors.sekufinOrange[70],
    "icon-brand": baseColors.sekufinOrange[40],
    ...
    "illustration-brand-secondary": baseColors.sekufinOrange[80],
    "illustration-brand-tertiary": baseColors.sekufinOrange[90],
    "metabase-brand": baseColors.sekufinOrange[40],
    "metabase-brand-hover": baseColors.sekufinOrange[50],
